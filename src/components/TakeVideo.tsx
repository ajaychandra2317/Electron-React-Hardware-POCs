    ...
    render() {
        ...
        return (
            <div style={{}}  className="App">
                ...
                <div>
                    <button onClick={this.getMediaDevices}
                ...
                <div>
                    {
                        this.state.mediaDevices.map((camera: any) => 
                            <button key={camera.label} onClick={() => this.setDevice(camera)}
                            style={{fontWeight: '500', fontFamily: 'cursive', fontSize: '20px', backgroundColor: '#009900', color: 'white', height: '38px', outline: 'none',
                            border: 'none',
                            borderRadius: '10px',
                            padding: '0px 20px',
                ...
                <div>
                    {
                        ...
                        <ReactMediaRecorder
                            ...
                            render={({ status, startRecording, stopRecording, mediaBlobUrl }) => (
                                <div>
                                <p style={{color: '#990099', fontFamily: 'cursive', textTransform: 'capitalize'}}>Status: {status}</p>
                                    <button onClick={startRecording}
                                        style={{
                                            fontWeight: '500', fontFamily: 'cursive', fontSize: '20px', backgroundColor: '#009900', color: 'white', height: '38px', outline: 'none',
                            border: 'none',
                            borderRadius: '10px',
                            padding: '0px 20px',
                            cursor: 'pointer',
                            ...
                            marginRight: '10px'
                                    ...
                                    <button onClick={stopRecording}
                                        style={{
                                            fontWeight: '500', fontFamily: 'cursive', fontSize: '20px', backgroundColor: '#e60000', color: 'white', height: '38px', outline: 'none',
                            border: 'none',
                            borderRadius: '10px',
                            padding: '0px 20px',
                            cursor: 'pointer',
                            ...
                            marginTop: '20px'
                                    ...
                                    {
                                        mediaBlobUrl ?
                                        <video src={mediaBlobUrl} controls autoPlay loop width="250" height="180"
                                    style={{ 
